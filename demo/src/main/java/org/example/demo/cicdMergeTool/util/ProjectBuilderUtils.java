...
import  org.example.demo.cicdMergeTool.model.ConflictBlock;
import  org.example.demo.cicdMergeTool.model.IMergeBlock;
import  org.example.demo.cicdMergeTool.model.NonConflictBlock;
...
public class ProjectBuilderUtils {
    ...
    public void saveProjects(List<Project> projects, Map<String, ObjectId> nonConflictObjects) throws IOException {
        ...
        for (Project project : projects) {
            ...
            MyFileUtils.saveFilesFromObjectId(projectNewRootPath, nonConflictObjects, git);
