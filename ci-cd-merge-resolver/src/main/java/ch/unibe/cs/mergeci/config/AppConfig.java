...
public class AppConfig {
    ...
    // ========== SHARED DATA SOURCES (RQ2 + RQ3) ==========
    /** Merge commit CSV shared by RQ2 and RQ3 (generated by extract_from_sql_dump.py). */
    public static final Path MERGE_COMMITS_CSV          = DATA_BASE_DIR.resolve("merge_commits.csv");
