...
import ch.unibe.cs.mergeci.experimentSetup.ExcelWriter;
import ch.unibe.cs.mergeci.experimentSetup.mergeCollection.MergeCheckoutProcessor.MergeProcessResult;
...
public class DatasetRowBuilder {
     ...
     */
    public ExcelWriter.DatasetRow buildRow(MergeProcessResult result) {
     ...
     */
    private boolean isMultiModule(MergeProcessResult result) {
